...
if(isset($Email)){
  ...
  $info = "SELECT student_id, full_name, gender, dob, email, branch, student_number, parent_number, course, c_name, batch_timing, photofile, city,referral_code ,referral_point FROM student_admission WHERE email = '$mb'";
...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com" />
    ...
    <link rel="stylesheet" href="/student_dashboard pj/student_register/css/ad.css"/>
  ...
  <div class="container ">
    ...
    <?php
        ...
        <div class="popup-container">
            <div class="left">
                <img  class="hero-image"  src="/student_dashboard/student_register/images/astrisc.png" width="230" height="304" />
            </div>
            <div class="right">
    ...
    <script src="/student_dashboard pj/student_register/js/ad.js"></script>
