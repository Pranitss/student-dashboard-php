										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<select id="brunch" style="color: gray; font-size: 14px;" class="form__input form-control" name="branch"  ="">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="course">Course</label>
														<select id="coname" style="color: gray; font-size: 14px;" class="form__input form-control"  name="course"  ="">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<select id="btname" style="color: gray; font-size: 14px;" class="form__input form-control" name="batch_timing"  ="">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input style="font-size: 14px; background-color: transparent;" id="sfilename" type="file" name="photofile" class="form__input form-control" accept="image/png, image/jpeg, image/jpg"  >
													<div class="mb-2 text-danger form__input-error-message"></div> 
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input style="font-size: 14px; background-color: transparent;" id="dfilename" type="file" name="docfile" class="form__input form-control" accept="image/png, image/jpeg, image/jpg"  >
													<div class="mb-2 text-danger form__input-error-message"></div> 
												</div>
											</div>
