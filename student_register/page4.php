										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" value="<?php echo $tfees;?>" id="tfees" name="total_fees" class="form-control" readonly  >
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text"  id="pfees" name="paid_fees" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div> 
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<select style="color: gray; font-size: 14px;" id="ptype" class="form__input form-control" name="payment_type"  >
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input style="color: gray; font-size: 14px;" type="date"  id="adate"name="admission_date" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div> 
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input style="font-size: 14px;" id="rno" type="text" name="receipt_number" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div> 
												</div>
											</div>
