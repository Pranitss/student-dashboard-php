							...
							<div class="row justify-content-center py-md-5">
								<div class="col-lg-9">
				          		...
				          		<span>or</span>
									...
									<div class="w-100">
										<p class="mt-4">Create a new account! <a href="/student_dashboard pj/student_register/registration.php">Sign Up</a></p>
										<p class="mt-4"> <a href="forgotpassword.php">Forgot Your Password?</a></p>
