										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text " id="fullname"  name="name" class="form__input form-control"  >
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" id="ebox"  name="email" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>  
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text"  name="referral_code" class="form__input form-control" placeholder="">
													<div class="mb-2 text-danger form__input-error-message"></div>  
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select style="color: gray; font-size: 14px;" id="gen" class="form__input form-control" name="gender"  >
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input style="color: gray; font-size: 14px;" id="dateob" type="date" name="dob" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input id="telnam1" style="font-size: 14px;" type="text" name="student_number" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input id="telnam2" style="font-size: 14px;" type="tel" name="parent_number" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" id="addr" name="address" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" id="citye" name="city" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" id="pinco" name="pincode" class="form__input form-control"  >
													<div class="mb-2 text-danger form__input-error-message"></div>
												</div>
											</div>
