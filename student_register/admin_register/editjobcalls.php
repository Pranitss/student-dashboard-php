...
if (isset($_GET['company_id'])) {
  ...
  $company_id = $_GET['company_id'];
    ...
    $sql = "SELECT * FROM job_calls WHERE company_id = '$company_id'";
    ...
    if ($result->num_rows == 1) {
      ...
      $com_state = $row['com_state'];
      $com_salary= $row['com_salary'];
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Update Student Information</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
      ...
      <div class="flex flex-col flex-1">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
           ...
           <form action="editjobcallsaction.php" method="post">
            <h4
            ...
            >
              <label class="block text-sm">
                ...
                <input
                  ...
                  value="<?php echo $company_name; ?>" required><br>
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                >
                  <input
                    ...
                    type="text" id="job_title" name="job_title" value="<?php echo $job_title; ?>" required><br>
                  <div
              ...
              <label class="block text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  type="text" id="com_city" name="com_city" value="<?php echo $com_city; ?>" required><br>
              ...
              <label class="block text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  type="text" id="com_state" name="com_state" value="<?php echo $com_state; ?>" required><br>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  ...
                  rows="2"
                  type="text" id="com_salary" name="com_salary" value="<?php echo $com_salary; ?>" required><br>
