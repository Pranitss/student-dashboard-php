...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Job Calls - Admin Dashboard</title>
    <link
...
-->
<!-- New Table -->
<form action="jobcallsaction.php" method="Post">
            ...
            >
              <label class="block text-sm">
               ...
               <br>
               <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Company City</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  name="com_city" id="company_city"
                  value="" required><br>
              </label>
              <br>
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Company State</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  type="text" id="com_state" name="com_state" value="" required><br>
              ...
              <label class="block text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  type="text" id="com_salary" name="com_salary" value="" required><br>
